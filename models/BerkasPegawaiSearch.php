...
/**
 * BerkasPegawaiSearch represents the model behind the search form of `app\models\BerkasPagawai`.
 */
class BerkasPegawaiSearch extends BerkasPagawai
{
    /**
     * {@inheritdoc}
     */
