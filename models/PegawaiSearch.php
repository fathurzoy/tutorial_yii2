...
class PegawaiSearch extends Pegawai
{
    ...
    public function rules()
    {
        return [
            ...
            [['jenis_pegawai', 'status_pegawai', 'jabatan', 'tanggal_bergabung', 'nama_pegawai', 'alamat', 'jenis_kelamin', 'ktp'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query
            ...
            ->andFilterWhere(['personal.alamat' => $this->alamat])
            ->andFilterWhere(['like', 'personal.no_ktp', $this->ktp]);
